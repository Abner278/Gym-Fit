...
// Get user ID to view from GET request
if (!isset($_GET['uid'])) {
...
// Fetch attendance for this month for the TARGET USER
...
<head>
    ...
    <title>Attendance Report - <?php echo htmlspecialchars($full_name); ?></title>
...
<body>
        ...
        <div class="member-details">
            ...
            <div style="display:flex; justify-content:space-between;">
                <div>
                    ...
                    <strong>Member ID:</strong> #<?php echo str_pad($target_user_id, 4, '0', STR_PAD_LEFT); ?>
                </div>
    ...
    <script>
        function downloadPDF() {
            ...
            const opt = {
                margin: 0.3,
                filename: `Attendance_${memberName}_<?php echo $month_name; ?>_<?php echo $year; ?>.pdf`,
